...
Return ONLY the JSON.`
    ...
    const { text: visionResult, usage: _uv } = await callClaudeVision(
      systemPrompt,
      image_url,
    ...
    logAiUsage({ function_name: 'agent-photo-tagger', model_provider: 'anthropic', model_name: 'claude-sonnet-4-20250514', input_tokens: _uv.input_tokens, output_tokens: _uv.output_tokens, duration_ms: Date.now() - _tv, status: 'success' })
