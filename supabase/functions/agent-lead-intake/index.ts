...
Keep it to 3-4 sentences. Conversational and professional. No em dashes.`
    ...
    const { text: ackMessage, usage: _u } = await callClaude(
      ackSystemPrompt,
...
Draft the acknowledgment message.`,
    ...
    logAiUsage({ function_name: 'agent-lead-intake', model_provider: 'anthropic', model_name: 'claude-sonnet-4-20250514', input_tokens: _u.input_tokens, output_tokens: _u.output_tokens, duration_ms: Date.now() - _t0, status: 'success' })
