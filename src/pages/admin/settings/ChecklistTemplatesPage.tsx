...
export function ChecklistTemplatesPage() {
  ...
  if (isLoading) {
    return (
      <div className="space-y-5 pb-10">
        <PageHeader title="Checklist Templates" subtitle="Master definitions of every checklist. Triggers determine when they auto-generate." />
  ...
  if (error) return (
    <div className="p-8 text-center">
      <p className="text-sm text-[var(--text-secondary)] mb-3">Unable to load checklist templates. Check your connection and try again.</p>
