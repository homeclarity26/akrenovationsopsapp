...
export function PayrollReportsPage() {
  ...
  const { data: payrollRecords = [], error, refetch } = useQuery({
  ...
  if (error) return (
    <div className="p-8 text-center">
      <p className="text-sm text-[var(--text-secondary)] mb-3">Unable to load payroll reports. Check your connection and try again.</p>
